...
public class MaxHeap<E extends Comparable<E>> {
	...
	//return all elements at least as large as e.
	public ArrayList<E> gt(E e){
	  ArrayList<E> al = new ArrayList<E>();
	  gtHelp(e, al, 0);
	  return al;
	}

	private void gtHelp(E e, ArrayList<E> l, int pos){
	  if(Heap.get(pos).compareTo(e)>=0){
	    l.add(Heap.get(pos));
            if(2 * pos + 1 < n)
	      gtHelp(e,l,leftchild(pos));
            if(2 * pos + 2 < n)
	      gtHelp(e,l,rightchild(pos));
	  }
	}
}
